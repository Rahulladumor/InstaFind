...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url(); ?>/assets/business/assets/css/bootstrap.min.css" />
	<link rel="stylesheet" href="<?php echo base_url(); ?>/assets/business/assets/js/bootstrap.min.js" />
...
<div class="container">
	<div class="row">	
        ...
        <div class="col-md-8">
            ...
            <form method="post" id="product_info" enctype="multipart/form-data" action="<?php echo site_url("business/Welcome/check"); ?>">                                                                  
                <div class="form-group">                      
                  <input type="number"  name="payble_amount" id="payble_amount" class="form-control" placeholder="Enter Payble Amount" value="<?php echo @$pamt; ?>" required/>
                  <input type="hidden" name="bid" value="<?php echo @$bid; ?>">
                  <input type="hidden" name="pid" value="<?php echo @$pid; ?>">
                </div>
                <div class="form-group">
                    <input type="text" name="product_info" id="product_info" class="form-control"  Placeholder="Product info name" value="<?php echo @$ptype; ?>" required/>
                </div>
               <div class="form-group">                      
                  <input type="text"  name="customer_name" id="customer_name" class="form-control" placeholder="Full Name (Only alphabets)" value="<?php echo @$bname; ?>" required/>
                </div>
                <div class="form-group">                                   
                  <input type="number"  name="mobile_number" id="mobile_number" class="form-control" placeholder="Mobile Number(10 digits)" value="<?php echo @$bcontact; ?>" required/>
                </div>
                <div class="form-group">                                   
