...
<html>
    <head>
        ...
        <title>Business Dashboard-Insta Find</title>
        ...
        <link href="<?php echo base_url();?>assets/business/assets/plugins/datatables/css/jquery.datatables.min.css" rel="stylesheet" type="text/css"/>
        <link href="<?php echo base_url();?>assets/business/assets/plugins/dropzone/dropzone.min.css" rel="stylesheet" type="text/css"/>
        <link href="<?php echo base_url();?>assets/business/assets/plugins/slidepushmenus/css/component.css" rel="stylesheet" type="text/css"/>	
        <link href="<?php echo base_url();?>assets/business/assets/plugins/weather-icons-master/css/weather-icons.min.css" rel="stylesheet" type="text/css"/>	
        <link href="<?php echo base_url();?>assets/business/assets/plugins/metrojs/MetroJs.min.css" rel="stylesheet" type="text/css"/>	
        <link href="<?php echo base_url();?>assets/business/assets/plugins/toastr/toastr.min.css" rel="stylesheet" type="text/css"/>	
        <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/business/assets/plugins/pricing-tables/css/style.css">
        	
        <!-- Theme Styles -->
        <link href="<?php echo base_url();?>assets/business/assets/css/modern.css" rel="stylesheet" type="text/css"/>
    ...
    <body class="page-header-fixed">
        ...
        <div class="menu-wrap">
            <nav class="profile-menu">
                <div class="profile">
                    <img src="<?php echo base_url("upload/owner/");?><?php echo @$owner_info["image"]; ?>" width="52" height="52" style="border-radius: 30%;" alt="David Green"/>
                    <span>
                        <?php echo @$owner_info["name"]; ?>
                    </span>
                </div>
        ...
        <main class="page-content content-wrap" style="background-color: #E9EDF2;">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="index.html" class="logo-text"><span><img src="<?php echo base_url();?>assets/user/images/favicon/favi.png"></span></a>
                    </div><!-- Logo Box -->
                    ...
                    <div class="topmenu-outer">
                        <div class="top-menu">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                                        <span class="user-name"><?php echo @$owner_info["name"]; ?><i class="fa fa-angle-down"></i></span>
                                        <img class="img-circle avatar" src="assets/images/avatar1.png" width="40" height="40" alt="">
                                    </a>
                                    <ul class="dropdown-menu dropdown-list" role="menu">
                                        <li role="presentation"><a href="<?php echo site_url("business/owner_con/owner_profile"); ?>"><i class="fa fa-user"></i>Profile</a></li>
                                        <li role="presentation"><a href="<?php echo site_url("business/owner_con/change_password_view"); ?>"><i class="fa fa-lock"></i>Change Password</a></li>
                                        <li role="presentation"><a href="inbox.html"><i class="fa fa-envelope"></i>Inbox<span class="badge badge-success pull-right">4</span></a></li>
                                        <li role="presentation" class="divider"></li>
                                        <li role="presentation"><a href="lock-screen.html"><i class="fa fa-lock"></i>Lock screen</a></li>
                                        <li role="presentation">
                                            <a href="<?php echo site_url("business/owner_con/logout_owner"); ?>"><i class="fa fa-sign-out m-r-xs"></i>Log out</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="<?php echo site_url("business/owner_con/logout_owner"); ?>" class="log-out waves-effect waves-button waves-classic">
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                <div class="sidebar-profile-image">
                                    <img src="<?php echo base_url("upload/owner/");?><?php echo @$owner_info["image"]; ?>" width="52" alt="<?php echo @$owner_info["name"]; ?>" class="img-circle img-responsive"/>
                                </div>
                                <div class="sidebar-profile-details">
                                    <span><?php echo @$owner_info["name"]; ?><br><small>Art Director</small></span>
                                </div>
                            </a>
                        </div>
                    </div>
                    <ul class="menu accordion-menu">
                        <li><a href="<?php echo site_url("business/owner_con/index"); ?>" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Dashboard</p></a></li>
                        <li><a href="<?php echo site_url("business/owner_con/owner_profile"); ?>" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-user"></span><p>Profile</p></a></li>
                        <li><a href="<?php echo site_url("business/owner_con/add_business"); ?>" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Add Business</p></a></li>
                        <li><a href="<?php echo site_url("business/owner_con/show_business"); ?>" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Show Business</p></a></li>
                        
                        <li><a href="<?php echo site_url("business/owner_con/show_reviews"); ?>" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Reviews</p></a></li>
                        <li><a href="<?php echo site_url("business/owner_con/show_comment"); ?>" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Comment</p></a></li>
                        
                        <li><a href="<?php echo site_url("business/owner_con/show_package_payment"); ?>" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Payment History</p></a></li>
                       
                        <!-- <li class="active"><a href="index.html" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Bookings</p></a></li> -->
                        <!-- <li class="active"><a href="index.html" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Apply Package</p></a></li> -->
                        <!-- <li class="active"><a href="index.html" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Apply Promotion</p></a></li> -->
                    </ul>
