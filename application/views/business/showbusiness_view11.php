		 			 ...
		 			 <div class="container">
		    			<center>
		   					...
		   					<div class="location text-sm-center">
		   						<a href="<?php echo site_url("business/business_con/show_packages/");echo $business['business_id']."/". rawurlencode($business['name'])."/".$business['contact']; ?>"><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#paymentmodal" >Payment</button></a>
		   					</div>
		   					<?php } ?>
		    			</center>
		  			</div>
