					...
					<ul class="feature-slider clearfix">
						<li class="item"><!-- .ITEM -->
							<div class="feature-item">
								<div class="figure">
									<img src="<?php echo base_url(); ?>assets/user/images/carousel/01.jpg" alt="feature item"/>
						...
						<li class="item"><!-- .ITEM -->
							<div class="feature-item">
								<div class="figure">
									<img src="<?php echo base_url(); ?>assets/user/images/carousel/02.jpg" alt="feature item"/>
									<div class="feature-overlay">
						...
						<li class="item"><!-- .ITEM -->
							<div class="feature-item">
								<div class="figure">
									<img src="<?php echo base_url(); ?>assets/user/images/carousel/03.jpg" alt="feature item"/>
									<div class="feature-overlay">
						...
						<li class="item"><!-- .ITEM -->
							<div class="feature-item">
								<div class="figure">
									<img src="<?php echo base_url(); ?>assets/user/images/carousel/04.jpg" alt="feature item"/>
									<div class="feature-overlay">
						...
						<li class="item"><!-- .ITEM -->
							<div class="feature-item">
								<div class="figure">
									<img src="<?php echo base_url(); ?>assets/user/images/carousel/05.jpg" alt="feature item"/>
									<div class="feature-overlay">
